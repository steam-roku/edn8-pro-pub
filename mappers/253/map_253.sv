module map_253(//VRC4e with CHR-RAM banks 4/5
...
//************************************************************* mapper-controlled pins
	...
	assign chr.we 				= (ppu.addr[12:10] == 4 || ppu.addr[12:10] == 5) ? !ppu.we : 0; // CHR-RAM for banks 4 and 5
...
//************************************************************* mapper implementation
	...
	// VRC4e addressing: A0 = CPU A2, A1 = CPU A3
	wire [1:0]map_ax = cpu.addr[3:2];
